...
select a.order_id,a.customer_id,b.salesman_id from orders a  
INNER JOIN salesman b on a.salesman_id = b.salesman_id;

select a.order_no,a.customer_id,b.salesman_id from orders a  
INNER JOIN salesman b on a.salesman_id = b.salesman_id;
...
select avg(grade) from salesman;

select * from customers;

select * from salesman;

select count(c.customer_name) from customers c 
INNER JOIN salesman s on c.salesman_id = s.salesman_id where s.grade> (select avg(grade) from salesman);

SELECT grade, COUNT(*) FROM customers 
GROUP BY grade HAVING grade>(SELECT AVG(grade) FROM customers WHERE city='New York');

select count s.grade(c.customer_name) from customers c 
INNER JOIN salesman s on c.salesman_id = s.salesman_id where s.grade> (select avg(grade) from salesman) and c.city = 'New York';

select count s.grade(c.customer_name) from customers c 
INNER JOIN salesman s on c.salesman_id = s.salesman_id where c.city = 'New York' and s.grade> (select avg(grade) from salesman);

select count s.grade(c.customer_name) from customers c 
INNER JOIN salesman s on c.salesman_id = s.salesman_id where s.grade> (select avg(grade) from salesman WHERE city='New York');
